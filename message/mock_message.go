...
// Source: github.com/shubham1dubay/metalgo/message (interfaces: OutboundMessage)
//
// Generated by this command:
//
//	mockgen -package=message -destination=message/mock_message.go github.com/shubham1dubay/metalgo/message OutboundMessage
//
