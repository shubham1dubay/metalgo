...
// Source: github.com/shubham1dubay/metalgo/database (interfaces: Batch)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_batch.go github.com/shubham1dubay/metalgo/database Batch
//
