...
// Source: github.com/shubham1dubay/metalgo/database (interfaces: Iterator)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_iterator.go github.com/shubham1dubay/metalgo/database Iterator
//
