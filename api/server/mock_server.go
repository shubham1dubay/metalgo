...
// Source: github.com/shubham1dubay/metalgo/api/server (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -package=server -destination=api/server/mock_server.go github.com/shubham1dubay/metalgo/api/server Server
//
